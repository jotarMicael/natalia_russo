...
<head>
    ...
    <title><?php echo HEAD; ?> | Servicios</title>
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12 ">
                            <div class="card card-maroon">
                                <div class="card-header">
                                    <h3 class="card-title"><strong>Registrar servicio</strong> <i class="fas fa-tools"></i></strong></h3>
                                </div>
                                <div class="card-body">
                                    <div class="container">
                                ...
                                <div class="card-footer">
                                    ...
                                    <button onclick="create_service();" type="submit" class="btn bg-orange"><i class="fas fa-tools"></i> Registrar servicio</button>
                                </div>
                            </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header"> <strong><i class="fas fa-tools"></i> Servicios</strong></div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    ...
                                    <?php } else { ?>
                                        <span class="text-danger">No posee ningún servicio</span>
                                    <?php } ?>
                                </div>
                                <!-- /.card-body -->
                            </div>
